...
class Table(object):
    ...
    def __init__(self):
        ...
        self.row_per_page = 40
        self.row_per_page_count = 0

    def setRowPerPage(self, rows_per_page):
        """
        Set the number of rows to draw per page.
        This is used to determine when to draw a new header.
        """
        self.row_per_page = rows_per_page
    ...
    def get_page_count(self):
        result = (self.get_row_count() + 1) // self.get_rows_per_page()
        if result == 0:
            return 1
        else:
            return result + 1
    ...
    def draw_some(self, canvas, left, right, yoff, vspace):
        ...
        # Do we need a row?
            ...
            if height < vspace:
                ...
                self._drew_header = False
            if self.row_per_page_count >= self.row_per_page:
                self._drew_header = False
                self.row_per_page_count = 0
                used = vspace
